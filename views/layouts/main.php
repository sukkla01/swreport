        ...
        <div class="wrap">
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'บันทึกข้อมูล',
                        'items' => [
                            ['label' => 'ระบบบำบัดน้ำเสีย', 'url' => ['/wastewater']],
                            ['label' => 'ระบบน้ำประปา', 'url' => ['/prapa']],
...
foreach (Yii::$app->session->getAllFlashes() as $key => $message){
    echo '<div class="alert alert-'.$key.' role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'.ucfirst($key).'!'.$message.'</div>';
}
?>
<?= $content ?>
            </div>
